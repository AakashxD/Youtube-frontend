...
import { YOUTUBE_SEARCH_API } from '../Utils/const.config';

const Head = () => {
  const [searchQuery, setSearchQuery] = useState("");
  const [suggestion,setSuggestion]=useState([]);
  const [searchBarSuggestion,setSearchBarSuggestion]=useState(false);
 ...
 */
  ...
  <img  className=" h-14 mx-2" src="data:image/png;base64," alt="LOGO" />
      ...
      <input
          ...
          onFocus={() => setSearchBarSuggestion(true)}
        onBlur={()=>{
          setSearchBarSuggestion(false)
        }}
         
          className="border border-gray-400 p-1 w-3/4 rounded-l-full"
          placeholder="Search..."
        />
        <button className="border border-gray-400 p-1 px-5 rounded-r-full bg-gray-100">🔍</button>
      </div>
    { searchBarSuggestion && (
        <div className=' absolute bg-white py-2 px-3 w-[28.4rem] shadow-lg rounded-sm rounded-lg '>
        <ul>
           {suggestion.map((e) => (
             <li key={e} className=" px-2 py-2 shadow-sm ">🔍{e}</li>
           ))}
           </ul>
      ...
      <div className="col-span-1">
        <img
          className="h-8"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSV9AzSnXt_qAhSIlpdgNkVQ5hxZDLptJ8z-JxVZg&s"
          alt="user"
        />
      </div>
    </div>
